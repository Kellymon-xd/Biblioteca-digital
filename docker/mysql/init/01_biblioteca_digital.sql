...
-- En Docker el usuario se crea mediante variables de entorno:
-- MARIADB_USER y MARIADB_PASSWORD en docker-compose.yml.
-- No se crea aquí para evitar contraseñas fijas dentro del SQL.
-- ============================================================
