            ...
            <tbody>
              <?php foreach ($usuarios as $usuario): ?>
                <tr>
                  ...
                  <td><span class="badge bg-light text-dark border"><?= Sanitizador::html($usuario['username'] ?? '') ?></span></td>
                  <td><span class="badge bg-light text-dark border"><?= Sanitizador::html($usuario['rol_nombre'] ?? $usuario['rol'] ?? '') ?></span></td>
