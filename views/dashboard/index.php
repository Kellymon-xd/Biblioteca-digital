  ...
  <div class="col-sm-6 col-xl-3">
    <div class="card border-0 shadow-sm h-100">
      <div class="card-body d-flex align-items-center gap-3">
        <div class="rounded-3 p-3 bg-<?= $c['color'] ?> bg-opacity-10 text-<?= $c['color'] ?>">
          <i class="bi bi-<?= $c['icon'] ?> fs-2"></i>
        </div>
        <div>
          <div class="fs-2 fw-bold"><?= $c['val'] ?></div>
      ...
      <div class="table-responsive">
        <table class="table table-hover mb-0 align-middle">
          <thead class="table-light"><tr>
            <th>#</th><th>Libro</th><th>Estudiante</th><th>Estado</th><th>Fecha</th>
          </tr></thead>
          <tbody>
          ...
          <tr>
            ...
            <td><?= Sanitizador::html($r['estudiante']) ?></td>
            <td>
    ...
    <div class="card border-0 shadow-sm">
      ...
      <ul class="list-group list-group-flush">
        ...
        <li class="list-group-item px-3 py-2">
          ...
          <strong><?= Sanitizador::html($log['username'] ?? '?') ?></strong>
